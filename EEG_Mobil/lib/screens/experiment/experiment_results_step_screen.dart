      ...
      child: ListView(
        ...
        children: [
          ...
          if (result != null) ...[
            ...
            const SizedBox(height: 14),
            _phaseCard('1. Baseline', result.baseline),
            const SizedBox(height: 14),
            _phaseCard('2. Reels', result.reels),
            const SizedBox(height: 14),
            _phaseCard('3. Metin', result.text),
            const SizedBox(height: 14),
            _bandsCard(result),
            const SizedBox(height: 14),
            _chartsCard(result),
      ...
      children: [
        Wrap(
          ...
          children: [
            ...
            _chip('Interest', result.averageInterest),
            _chip('Engagement', result.averageEngagement),
            _chip('Excitement', result.averageExcitement),
            _chip('Mental Fatigue', result.mentalFatigue),
            _chip('Distraction', result.distractionScore),
            _chip('Baseline Δ', result.baselineDifference, signed: true),
          ],
        ),
      ],
    );
  ...
  Widget _bandsCard(ExperimentResult result) {
    return _StatCard(
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(child: _metric('δ Delta', result.deltaPower, d: 2)),
            const SizedBox(width: 8),
