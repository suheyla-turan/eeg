                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      ...
                      hintText: 'örn. 192.168.1.113',
                      helperText:
                          'Boş bırak: son çalışan adres hatırlanır. Gerekirse PC Wi‑Fi IP (örn. 192.168.1.113) veya USB’de 127.0.0.1',
                    ),
                  ),
                  const SizedBox(height: 12),
                  TextField(
            ...
            SectionCard(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'Tek cihaz araştırma modu. Video ve okuma metinleri '
                    'uygulamaya gömülüdür (assets + kod). Firebase yalnızca '
                    'denek bilgisi, deney oturumu, izleme/quiz yanıtları ve '
                    'ham EEG dosyaları için kullanılır. EEG canlı verisi '
                    'Python API üzerinden WebSocket ile alınır.',
                  ...
                  const _InfoRow(
                    label: 'Giriş',
                    value: 'Anonim Auth (Storage yazma)',
                  ),
