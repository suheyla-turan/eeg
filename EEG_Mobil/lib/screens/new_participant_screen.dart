        ...
        children: [
          ...
          if (exp.experimentType == 'full' ||
            ...
            Text(
              ...
              'Reels (10 dk) → tüm metinler sırayla (10 dk) → analiz → sonuçlar.',
              style: TextStyle(
                fontSize: 13,
            ...
            if (exp.texts.isNotEmpty) ...[
              const SizedBox(height: 12),
              Text(
                '${exp.texts.length} aktif metin sırayla gösterilecek '
                '(seçim gerekmez).',
                style: TextStyle(
                  fontSize: 13,
                  color: AppColors.secondary(context),
          ...
          if (exp.experimentType == 'text' && exp.texts.isNotEmpty) ...[
            const SizedBox(height: 12),
            Text(
              '${exp.texts.length} aktif metin ve soruları 10 dakika içinde '
